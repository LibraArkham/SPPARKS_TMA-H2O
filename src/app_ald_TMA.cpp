...
enum{VACANCY,O,OH,Ala,OHAlaX3,OAlaX2,OAlaX2H2O,OAlaXOH,OAlaXOHH2O,OAlaX,OAlaXH2O,OAlaOH,OAlaOH2,AlaOH,AlaOH2,Alb,OHAlbX3,OAlbX2,OAlbX2H2O,OAlbXOH,OAlbXOHH2O,OAlbX,OAlbXH2O,OAlbOH,OAlbOH2,AlbOH,AlbOH2,OAla,OAlb,H2O};
...
int AppAldTMA::species_to_enum(const char* species_name) {
  ...
  else if (strcmp(species_name,"OAlaXOHH2O") == 0) return OAlaXOHH2O;
  else if (strcmp(species_name,"OAlaX") == 0) return OAlaX;  
  else if (strcmp(species_name,"OAlaXH2O") == 0) return OAlaXH2O;
  ...
  else if (strcmp(species_name,"OAlbXOHH2O") == 0) return OAlbXOHH2O;
  else if (strcmp(species_name,"OAlbX") == 0) return OAlbX;
  else if (strcmp(species_name,"OAlbXH2O") == 0) return OAlbXH2O;
